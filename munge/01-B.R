...
tblMA_EMA005 <- data.frame(key,date,"spl", ema.005)                             # Create Exponential Moving Average table
tblMA_EMA010 <- data.frame(key,date,"spl", ema.010)                             # Create Exponential Moving Average table
tblMA_EMA020 <- data.frame(key,date,"spl", ema.020)                             # Create Exponential Moving Average table
tblMA_EMA050 <- data.frame(key,date,"spl", ema.050)                             # Create Exponential Moving Average table
tblMA_EMA100 <- data.frame(key,date,"spl", ema.100)                             # Create Exponential Moving Average table
tblMA_EMA200 <- data.frame(key,date,"spl", ema.200)                             # Create Exponential Moving Average table
tblMA_SMA005 <- data.frame(key,date,"spl", sma.005)                             # Create Simple Moving Average table
tblMA_SMA010 <- data.frame(key,date,"spl", sma.010)                             # Create Simple Moving Average table
tblMA_SMA015 <- data.frame(key,date,"spl", sma.015)                             # Create Simple Moving Average table
tblMA_SMA020 <- data.frame(key,date,"spl", sma.020)                             # Create Simple Moving Average table
tblMA_SMA050 <- data.frame(key,date,"spl", sma.050)                             # Create Simple Moving Average table
tblMA_SMA100 <- data.frame(key,date,"spl", sma.100)                             # Create Simple Moving Average table
tblMA_SMA200 <- data.frame(key,date,"spl", sma.200)                             # Create Simple Moving Average table

tblMA_GoldenDeathX_EMA <-left_join(tblMA_EMA005, left_join(tblMA_EMA010, left_join(tblMA_EMA020, left_join(tblMA_EMA050, left_join(tblMA_EMA100, tblMA_EMA200)))))
tblMA_GoldenDeathX_SMA <-left_join(tblMA_SMA005, left_join(tblMA_SMA010, left_join(tblMA_SMA020, left_join(tblMA_SMA050, left_join(tblMA_SMA100, tblMA_SMA200)))))
