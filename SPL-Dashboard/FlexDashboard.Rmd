...
```{r 3.1.1.1.a-vbox-dispersion}

flexdashboard::renderValueBox({
  disp_last <-  percent(
                  xts::last(dt_bb20_disp[,6])
                )
  flexdashboard::valueBox(
        paste0("Dispersion: ", disp_last),
        color = "#BF5700",
        icon  = 'fa-cross'
  )
})
...
flexdashboard::renderValueBox({
  disp_dlt_last <-  percent(
                      xts::last(dt_bb20_disp[,7])
                    )
# ------------------------------------------------------------------------------
  flexdashboard::valueBox(
        paste0("Disp Delta: ", disp_dlt_last),
        color = "#BF5700",
        icon  = 'fa-cross'
  )
})
...
# ------------------------------------------------------------------------------
  flexdashboard::valueBox(
    ...
    color = ifelse(delt_max > 0, "teal", "red"),
    icon  = "ion-cash"
  )
})
...
```{r 3.4.1.4.a-vbox-noX-calendar-days}
...
```{r 3.4.1.4.b-vbox-noX-trade-days, eval=trend}
...
```{r 3.1.3.1-viz-bollinger-band-disp, eval=dt_bb20_disp}
...
```{r 3.1.3.2-viz-bollinger-band-disp-delta, eval=dt_bb20_disp}
...
```{r 3.1.3.1-viz-chaikan-money-flow, eval=price}
