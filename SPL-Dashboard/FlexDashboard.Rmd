...
# ------------------------------------------------------------------------------
SPL.AX                    <- tk_xts(readRDS(here::here("rds", "SPL.AX.rds")))
...
# ------------------------------------------------------------------------------
dXema                     <- blotter::put.portfolio("dXema", gXema, envir = .blotter)
...
blot <- ls.str(.blotter)
# gXemaAcct <- getAccount(paste("gXema"))
# load.strategy(here::here("rdata","gXema"))
...
```{r 2.2.2.4-viz-goldenx-posn-chartstats, eval=gXema}
  
  portfolio.st = "gXsma"
  renderPlot({
    log.chart.Posn(Portfolio = portfolio.st, Sym = "SPL.AX", Dates = NULL, env = .GlobalEnv)
#      add_MACD()
   })
```
