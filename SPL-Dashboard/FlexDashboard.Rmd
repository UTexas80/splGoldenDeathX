...
renderPlot({
  x <- tk_xts(price())
  # getSymbols("SPL.AX", src = "yahoo") # from yahoo finance
...
renderPlotly({
  ...
  histogram <- plot_ly(n, x = n$return, type = "histogram", marker = list(color = "#778899")) %>%
    layout(xaxis = xhp, yaxis = yhp)
  boxplot <- plot_ly(n, x = n$return, type = "box", boxpoints = "all", jitter = 0.3, marker =
    list(color = "#000000", outliercolor = "#778899")) %>%
    layout(yaxis = ybp)
...
renderPlotly({
  ...
  histogramN <- plot_ly(n, x = n$tradeDays, type = "histogram", marker = list(color = "#778899")) %>%
    layout(xaxis = xhp, yaxis = yhp)

  boxplotN <- plot_ly(n, x = n$tradeDays, type = "box", boxpoints = "all", jitter = 0.3, marker = list(color = "#000000", outliercolor = "#D0A92C", line = list(outliercolor = "#D0A92C", outlierwidth = 5))) %>%
    layout(yaxis = ybp)
