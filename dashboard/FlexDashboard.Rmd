...
# goldenX_EMA_results       <- readRDS(here::here("dashboard/rds", "goldenX_EMA_results.rds"))
...
### .xts Price & Transactions Chart
```{r 2.2.2.3-viz-goldenX-EMA-chartstats}
renderPlot({
  
    chart.Posn("goldenX_EMA_portfolio", 
           Symbol = "SPL.AX",  
