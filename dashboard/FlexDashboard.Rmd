...
Column {data-height=40%, data-width=500 .tabset .tabset-fade}
-------------------------------------
...
Column {data-height=45%, .tabset .tabset-fade}
-------------------------------------
### GoldenX Return
...
renderPlotly({
  ...
  subplot(boxplotG, histogramG, nrows = 2, shareX = TRUE) %>%
    ...
    layout(title = "GoldenX Box Plot & Histogram - ROI with Outliers", bargap = 0.1)
})
```

### GoldenX Trade Days

```{r 2.2.3.2-goldenx-trade-days}
xhpG <- list(title = g$catName, titlefont = F)
yhpG <- list(title = "Counts", titlefont = F)
ybpG <- list(title = g$catName, titlefont = F)
...
renderPlotly({
  ...
  subplot(boxplotN, histogramN, nrows = 2, shareX = TRUE) %>%
    layout(showlegend = FALSE) %>%
    layout(title = "No X Box Plot & Histogram - # of Trade Days with Outliers", bargap = 0.1)
})
```
