...
# ------------------------------------------------------------------------------
dt_trade_stats            <- readRDS(here::here("dashboard/rds", "dt_trade_stats.rds"))
dXema_trade_stats         <- readRDS(here::here("dashboard/rds", "dXema_trade_stats.rds"))
dXsma_trade_stats         <- readRDS(here::here("dashboard/rds", "dXsma_trade_stats.rds"))
gXema_trade_stats         <- readRDS(here::here("dashboard/rds", "gXema_trade_stats.rds"))
gXsma_trade_stats         <- readRDS(here::here("dashboard/rds", "gXsma_trade_stats.rds"))
...
# load.strategy(dXsma)
dXsma.rets.bh <-PortfReturns(Account = "dXsma")
gXsma.rets.bh <-PortfReturns(Account = "gXsma")
...
renderHighchart({
  chart.Posn("gXsma", Symbol = 'SPL.AX',TA = 'add_SMA(n = 10,col = 4, on = 1)')
})
# renderHighchart({
